// BinomialHeap.cpp: определяет точку входа для консольного приложения.
//
...
// З'єднує два біноміальних дерева
...
// З'єднує дві біноміальні піраміди
...
// Реорганізовує степінь вузлів піраміди у зростаючому порядку
...
int main()
{
	...
	cout << "Піраміда після вставки: " << endl;
	ShowHeap(MyHeap);

	cout << "Мінімальний елемент: " << getMin(MyHeap)->value << endl;

	MyHeap = extractMin(MyHeap);
	cout << "Піраміда після видалення мінімального елемента: " << endl;
	ShowHeap(MyHeap);
